...
$tournamentGroup->group('{id}')
	...
	->name('tournament-rozlos')
	->get('results', [TournamentResults::class, 'results'])
	->name('tournament-results')
	->get('gate', [TournamentResults::class, 'gate'])
	->name('tournament-gate')
	->get('teams', [TournamentController::class, 'teams'])
	->name('tournament-teams')
                ...
                ->group('play')
	->get('', [TournamentController::class, 'play'])
	->name('tournament-play')
	->get('list', [TournamentController::class, 'playList'])
	->name('tournament-play-list')
                ->group('{gameId}')
	->get('', [TournamentController::class, 'play'])
	->name('tournament-play-game')
