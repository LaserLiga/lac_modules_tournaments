...
$tournamentGroup->group('{id}')
    ...
    ->post('results/points', [TournamentResults::class, 'updateTeamPoints'])
    ...
    ->get('ops', [TournamentController::class, 'ops'])->name('tournament-ops')
    ->post('ops/pair', [TournamentController::class, 'opsPairImportedGame'])
    ->post('ops/recover', [TournamentController::class, 'opsRecover'])
    ...
    ->post('rozlos/clear', [TournamentController::class, 'rozlosClear'])
    ->post('rozlos/game/add', [TournamentController::class, 'addTournamentGame'])
    ->post('rozlos/game/{gameId}/update', [TournamentController::class, 'updateTournamentGame'])
    ->post('rozlos/game/{gameId}/delete', [TournamentController::class, 'deleteTournamentGame'])
    ->post('rozlos/game/{gameId}/move/{direction}', [TournamentController::class, 'moveTournamentGame'])
    ->post('progress', [TournamentController::class, 'progress'])
    ->post('progression/{type}/{progressionId}/undo', [TournamentController::class, 'undoProgression'])
    ->post('progression/{type}/{progressionId}/team', [TournamentController::class, 'setProgressionTeam'])
    ->group('play')
    ...
    ->post('results', [TournamentController::class, 'updateTournamentGameResults'])
